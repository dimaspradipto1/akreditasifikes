...
class MahasiswaController extends Controller
{
     ...
     */
    public function updateNarasi(MahasiswaRequest $request, $id)
    {
     ...
     * Store new Bukti.
     */
    public function storeBukti(MahasiswaRequest $request)
    {
     ...
     * Update Bukti.
     */
    public function updateBukti(MahasiswaRequest $request, $id)
    {
