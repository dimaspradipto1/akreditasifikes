...
<head>
    ...
    <meta name="description"
        content="Portal login Sistem Informasi Akreditasi Fakultas Ilmu Kesehatan Universitas Islam Syekh-Yusuf">
    ...
    <style>
        ...
        *::after {
        ...
        .alert-success {
            ...
            border: 1px solid rgba(85, 32, 184, 0.20);
        ...
        <div class="right-panel">
            ...
            <div class="logo-area">
                <div class="logo-img-wrap">
                    <img src="{{ asset('assets/img/logoxyz.png') }}" alt="Logo Universitas XYZ"
                ...
                <div class="field">
                    ...
                    <div class="input-wrap">
                        <input type="email" id="email" name="email"
                            ...
                            placeholder="nama@fikes.ac.id" autocomplete="email" autofocus required>
