...
<div class="pagetitle d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <small class="text-muted">{{ $settings_data['prodi_nama'] ?? 'S1 Kesehatan Lingkungan' }} ({{ $settings_data['prodi_jenjang'] ?? 'Sarjana' }}) - {{ count($elements) }} sub-kriteria pada kriteria ini</small>
    </div>
    <div class="text-end">
            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold text-success" style="line-height: 1;">{{ $memenuhiCount }} <span class="fs-6 fw-normal text-muted">dari {{ count($elements) }}</span></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold text-danger" style="line-height: 1;">{{ $wajibBelumMemenuhiCount }}</div>
                    </div>
                </div>
            </div>
        </div>
