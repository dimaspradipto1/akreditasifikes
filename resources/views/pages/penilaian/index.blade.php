            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold text-danger" style="line-height: 1;">{{ $subKriterias->filter(fn($s) => in_array($s->kriteria_kode, ['3.1', '3.2', '3.4']) && $s->status !== 'Memenuhi')->count() }}</div>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr style="border-bottom: 1px solid #f1f5f9;" class="bukti-row" data-id="{{ $bukti->id }}">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <form action="{{ route('penilaian.destroy', $bukti->id) }}" method="POST" class="d-inline form-delete-bukti">
                                                        @csrf
                                                        @method('DELETE')
