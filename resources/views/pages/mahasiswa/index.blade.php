    ...
    <div>
        <nav>
            <ol class="breadcrumb mb-1" style="font-size: 0.85rem;">
                ...
                <li class="breadcrumb-item active">K4 — Mahasiswa</li>
            </ol>
        </nav>
        <h1 class="mb-1" style="font-size: 1.5rem; font-weight: 700;">Kriteria 4 — Mahasiswa</h1>
            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 12px; background: #ffffff;">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold text-danger" style="line-height: 1;">{{ $subKriterias->filter(fn($s) => in_array($s->kriteria_kode, ['4.1', '4.4']) && $s->status !== 'Memenuhi')->count() }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <h2 class="accordion-header" id="headingSub{{ $sub->id }}">
                ...
                <div id="collapseSub{{ $sub->id }}" class="accordion-collapse collapse" aria-labelledby="headingSub{{ $sub->id }}" data-bs-parent="#accordionMahasiswa">
                    ...
                    <div class="bg-white p-3 rounded shadow-sm" style="border: 1px solid #e2e8f0;">
                        ...
                        @foreach($mahasiswa->buktis->where('kriteria_kode', $sub->kriteria_kode) as $bukti)
